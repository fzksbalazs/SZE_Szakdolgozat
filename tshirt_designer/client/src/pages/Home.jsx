          ...
          <motion.div className="home-content" {...headContainerAnimation}>
            <motion.div {...headTextAnimation}>
              <h1 className="head-text">
                3D-S <br className="hidden xl:block" />
                DESIGN.
              </h1>
            </motion.div>
            <motion.div
            ...
            >
              <p className="max-w-md text-base font-normal text-gray-600">
                Készítsd el a saját, egyedi és exkluzív pólódat vadonatúj 3D
                testreszabó eszközünkkel. Engedd szabadjára a{" "}
                <strong>fantáziád</strong>, és alakítsd ki a saját stílusod.
              </p>
